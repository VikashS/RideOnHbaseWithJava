	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			SingleColumnValueFilter filter = new SingleColumnValueFilter(Bytes.toBytes("Personal"),
					Bytes.toBytes("gender"), CompareFilter.CompareOp.EQUAL,
					new BinaryComparator(Bytes.toBytes("males")));
			filter.setFilterIfMissing(true);
			SingleColumnValueFilter filter2 = new SingleColumnValueFilter(Bytes.toBytes("Personal"),
					Bytes.toBytes("martial_status"), CompareFilter.CompareOp.EQUAL,
